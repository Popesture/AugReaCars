...
public class UserInterfaceButtonsplayer2 : MonoBehaviour
{
...
//	public GameObject Model;
	...
	public void RotationRightButton ()
	{
		...
		GameObject.FindWithTag ("enemyCar").transform.Rotate (0, -rotationSpeed * Time.deltaTime, 0);
	}
	...
	public void ScaleUpButton ()
	{
		// transform.localScale += new Vector3(scalingSpeed, scalingSpeed, scalingSpeed);
			GameObject.FindWithTag ("enemyCar").transform.localScale += new Vector3 (scalingSpeed, scalingSpeed, scalingSpeed);
		}
	...
	{
		GameObject.FindWithTag ("enemyCar").transform.Translate (0, 0, -translationSpeed * Time.deltaTime);
	}
	...
	{
		GameObject.FindWithTag ("enemyCar").transform.Translate (-translationSpeed * Time.deltaTime, 0, 0);
	}

	public void PositionLeftButton ()
	{
		GameObject.FindWithTag ("enemyCar").transform.Translate (translationSpeed * Time.deltaTime, 0, 0);  // backward
	}
